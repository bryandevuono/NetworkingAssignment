...
//     {
//         acked++;
//         Console.WriteLine($"Waiting for ack from client.");
//         Console.WriteLine($"Received ack from client {receivedMessage.Type} - {receivedMessage.Content}");
//     }
...
//     int totalPackets = fileData.Length;
//     int packetsSent = 0;
...
//             fileMessage.Content = fileData[sequenceNumber];
